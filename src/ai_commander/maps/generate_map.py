...
def generate():
    ...
    # Dodajemy do TERRAIN_TYPES koszty ruchu dla dróg i rzek, aby generator wiedział, jak je obsługiwać
    terrain_types = dict(TERRAIN_TYPES)  # skopiuj oryginalne typy
    terrain_types.update(ROAD_TYPES)     # dodaj drogi z kosztami ruchu
    terrain_types.update(OBSTACLE_TYPES) # dodaj rzeki/przeszkody z kosztami ruchu
    ...
    map_data = {
        ...
        "terrain": terrain_types,  # teraz z kosztami dla dróg i rzek
        "hexes": hexes,
        "roads": roads,
        "rivers": rivers
    }
